...
const metrodata = require('./_admmetrodata');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('owner')
        .setDescription('Comandos Exclusivos de MetroMan')
        .addSubcommand(subcommand => metrodata.data(subcommand)), 
    ...
    async execute(interaction) {
        ...
        if (interaction.user.id!=='1261050272906481808'
           ) return interaction.reply("Tú no eres MetroMan") 
        ...
        try {
            ...
            switch(subcommand) {
                case 'metrodata':
                    return metrodata.execute(interaction, metro); 
