...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            await interaction.followUp({ content: `✅ Usuario ${user.tag} ha sido baneado. Razón: ${reason}`, ephemeral: true });
        } catch (error) {
            await interaction.followUp({ content: '❌ No se pudo banear al usuario.', ephemeral: true });
        }
    },
};
