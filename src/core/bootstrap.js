...
async function performInitialization(source = 'unknown') {
    ...
    try {
        ...
        // The following code is commented out because it overwrites the statusTypes
        // configuration with incomplete data from the database, causing errors.
        // The application will now use the complete configuration from metroConfig.js.
        ...
        logger.error('[BOOTSTRAP] Failed to initialize DB Manager:', error);
