...
module.exports = {
    ...
    connectionEmojis: {
        ...
        'LineaCero': '<:lineaCero:1362490490850771064>',
        'BiciMetro': '<:biciMetro:1362491413794652210>',
        'UInvertida': '<:uinvertida:1354232925511487651>'  // Lock emoji for bike racks
    },
    ...
    statusTypes: {
        ...
        '1': { name: 'abierta', description: 'Estación Abierta', isOperational: true, severity: 1, color: 0x00FF00, emoji: '✅', discordem: '<:operativa:1348394413357010984>', notification: false },
        ...
        '3': { name: 'accesos controlados', description: 'Accesos controlados', isOperational: false, severity: 2, color: 0xFFFF00, emoji: '⚠️', discordem: '<:parcial:1348400125005008977>', notification: true },
        '4': { name: 'accesos parciales', description: 'Accesos parciales', isOperational: false, severity: 2, color: 0xFFFF00, emoji: '⚠️', discordem: '<:parcial:1348400125005008977>', notification: true },
        '5': { name: 'cerrada', description: 'Estación Cerrada', isOperational: false, severity: 4, color: 0xFF0000, emoji: '❌', discordem: '<:cerrada:1348394347045064766>', notification: true },
        ...
        '8': { name: 'servicio extendido solo entrada', description: 'Servicio extendido solo entrada', isOperational: true, severity: 2, color: 0x0000FF, emoji: '➡️', discordem: '<:extendida:1354249821829075155>', notification: true },
        '9': { name: 'servicio extendido solo salida', description: 'Servicio extendido solo salida', isOperational: true, severity: 2, color: 0x0000FF, emoji: '⬅️', discordem: '<:extendida:1354249821829075155>', notification: true },
        // Line Statuses
        '10': { name: 'operativa', description: 'Línea Operativa', isOperational: true, severity: 1, color: 0x00FF00, emoji: '✅', discordem: '<:operativa:1348394413357010984>', notification: false },
        ...
        '13': { name: 'parcial', description: 'Línea Parcialmente Operativa', isOperational: false, severity: 3, color: 0xFFA500, emoji: '⚠️', discordem: '<:parcial:1348400125005008977>', notification: true },
        '14': { name: 'suspendida', description: 'Línea Suspendida', isOperational: false, severity: 5, color: 0xFF0000, emoji: '❌', discordem: '<:cerrada:1348394347045064766>', notification: true },
        ...
        '16': { name: 'operativo', description: 'Operativo', isOperational: true, severity: 0, color: 0x00FF00, emoji: '✅', discordem: '<:operativa:1348394413357010984>', notification: false },
