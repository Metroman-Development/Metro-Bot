...
--
-- Dumping data for table `accessibility_status`
--

LOCK TABLES `accessibility_status` WRITE;
/*!40000 ALTER TABLE `accessibility_status` DISABLE KEYS */;
/*!40000 ALTER TABLE `accessibility_status` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `intermodal_buses`
--

LOCK TABLES `intermodal_buses` WRITE;
/*!40000 ALTER TABLE `intermodal_buses` DISABLE KEYS */;
/*!40000 ALTER TABLE `intermodal_buses` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `intermodal_stations`
--

LOCK TABLES `intermodal_stations` WRITE;
/*!40000 ALTER TABLE `intermodal_stations` DISABLE KEYS */;
/*!40000 ALTER TABLE `intermodal_stations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `metro_lines` (
  ...
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `display_name` varchar(100) GENERATED ALWAYS AS (concat('Línea ',ucase(substr(`line_id`,2)))) VIRTUAL,
...
--
-- Dumping data for table `scheduled_status_overrides`
--

LOCK TABLES `scheduled_status_overrides` WRITE;
/*!40000 ALTER TABLE `scheduled_status_overrides` DISABLE KEYS */;
/*!40000 ALTER TABLE `scheduled_status_overrides` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `status_overrides` WRITE;
/*!40000 ALTER TABLE `status_overrides` DISABLE KEYS */;
/*!40000 ALTER TABLE `status_overrides` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-08-23 12:55:38
